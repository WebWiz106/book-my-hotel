      ...
      <div className='px-5'>
         <div onBlur={handleMenu} className={`fixed top-13 p-5 right-[10%] flex rounded-lg flex-col item-top justify-start bg-zinc-700 bg-opacity-100 z-50 ${isMenuOpen ? 'w-auto transition-all duration-150 origin-top-right transform translate-x-0' : 'w-0 transform translate-x-full'}`}>
            <ul type='none' className=' gap-2 flex flex-col'>
               ...
               <Link onClick={handleMenu} to="/yourBooking"><li className=' text-white hover:bg-white hover:text-black rounded-md p-2 hover:cursor-pointer'>Your Booking</li></Link>
               <Link onClick={handleMenu} to="/rooms"><li className=' text-white hover:bg-white hover:text-black rounded-md p-2 hover:cursor-pointer'>Rooms</li></Link>
